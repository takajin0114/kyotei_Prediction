"""
EXP-0015: EXP-0013 の勝ち筋を深掘り。top_n_ev_gap_filter の局所探索。

ev_threshold × ev_gap_threshold の細かい組み合わせを n_w=12 で検証する。
ベースライン（EXP-0013 ベスト）: ev=1.18, ev_gap=0.05, overall_roi=-13.81%
"""
...
# EXP-0013 ベストを基準にした局所探索グリッド
EV_THRESHOLDS = [1.17, 1.18, 1.19, 1.20]
EV_GAP_THRESHOLDS = [0.03, 0.04, 0.05, 0.06, 0.07]

# EXP-0013 ベスト（比較基準）
EXP0013_BEST_EV = 1.18
EXP0013_BEST_EV_GAP = 0.05
EXP0013_BEST_ROI = -13.81
...
def main() -> int:
    ...
    out_path = output_dir / "exp0015_ev_gap_local_search_results.json"
    payload = {
        "experiment_id": "EXP-0015",
        "n_windows": args.n_windows,
        "seed": args.seed,
        "baseline_exp0013": {
            "ev_threshold": EXP0013_BEST_EV,
            "ev_gap_threshold": EXP0013_BEST_EV_GAP,
            "overall_roi_selected": EXP0013_BEST_ROI,
        },
        "results": results,
    }
