...
- 本ドキュメントは、競艇予測システムの設計・運用・API仕様・開発計画など横断的な内容を集約しています。
- ルート[README.md](../README.md)と連携し、全体像・参照フロー・索引を明記しています。
...
### 新規参加者向け
1. [../README.md](../README.md)（全体概要・セットアップ・索引）
2. [integration_design.md](integration_design.md)（システム全体設計）
3. [data_acquisition.md](data_acquisition.md)（データ取得運用・手順）
4. [../kyotei_predictor/data/README.md](../kyotei_predictor/data/README.md)（データ保存・命名規則）

### 開発者向け
1. [DEVELOPMENT_ROADMAP.md](DEVELOPMENT_ROADMAP.md)（長期計画・課題）
2. 各機能別設計書（docs/配下）
3. [../kyotei_predictor/tools/README.md](../kyotei_predictor/tools/README.md)（ツール運用）

### 運用者向け
1. [../kyotei_predictor/data/README.md](../kyotei_predictor/data/README.md)（データ運用ルール）
2. [data_acquisition.md](data_acquisition.md)（データ取得・再取得手順）
