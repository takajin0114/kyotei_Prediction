...
| ファイル | 用途 |
|----------|------|
| [notebooks/colab/colab_drive_learning_cycle_template.ipynb](../../notebooks/colab/colab_drive_learning_cycle_template.ipynb) | CPU で学習 |
| [notebooks/colab/colab_drive_learning_cycle_gpu_template.ipynb](../../notebooks/colab/colab_drive_learning_cycle_gpu_template.ipynb) | GPU で学習（推奨） |
