...
- **短期・7月データ**: B top_n=3 または B top_n=5 EV>1.05（高 ROI 維持）。
- **長期・複数月**: 月ごとのばらつきが大きいため、学習期間と検証期間の分離をした上で、B top_n=3 または B top_n=5 EV>1.05 を推奨。EV>1.10 は bet 数が多くなるが ROI は下がるトレードオフあり。
