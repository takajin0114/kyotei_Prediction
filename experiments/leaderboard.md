...
|---|---|---|---|---|---|---|---|---|
| 1 | EXP-0015 | xgboost | sigmoid | extended_features | top_n_ev_gap_filter | top_n=3, ev=1.20, ev_gap=0.07 | **-12.71%** (n_w=12) | EV gap 局所探索で新ベスト（adopt） |
...
### 条件: top_n=3, ev=1.18（EXP-0007 / 従来2位）、EXP-0013 ev_gap=0.05（現2位 -13.81%）、EXP-0015 ev=1.20 ev_gap=0.07（現1位 -12.71%）
